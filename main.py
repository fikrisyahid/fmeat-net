...
transform = v2.Compose(
  [
    ...
    v2.Normalize(
      mean=[0.5484, 0.3619, 0.3821] if config.MODEL_USED == "CNN" else [0.5480, 0.3614, 0.3816],
      std=[0.1129, 0.1049, 0.1092] if config.MODEL_USED == "CNN" else [0.1173, 0.1091, 0.1134],
    ),
  ]
)
